...
# cstracer/Makefile.  Generated from Makefile.in by configure.
...
PACKAGE_STRING = Valgrind 3.12.0.SVN
PACKAGE_TARNAME = valgrind
PACKAGE_URL = 
PACKAGE_VERSION = 3.12.0.SVN
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
cstracer_amd64_linux_SOURCES = \
	$(CSTRACER_SOURCES_COMMON)

cstracer_amd64_linux_CPPFLAGS = \
	$(AM_CPPFLAGS_AMD64_LINUX)

cstracer_amd64_linux_CFLAGS = \
	$(AM_CFLAGS_AMD64_LINUX)

cstracer_amd64_linux_DEPENDENCIES = \
	$(TOOL_DEPENDENCIES_AMD64_LINUX)

cstracer_amd64_linux_LDADD = \
	$(TOOL_LDADD_AMD64_LINUX)

cstracer_amd64_linux_LDFLAGS = \
	$(TOOL_LDFLAGS_AMD64_LINUX)

cstracer_amd64_linux_LINK = \
...
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am $(top_srcdir)/Makefile.tool.am $(top_srcdir)/Makefile.all.am $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign cstracer/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign cstracer/Makefile
...
cstracer-amd64-linux$(EXEEXT): $(cstracer_amd64_linux_OBJECTS) $(cstracer_amd64_linux_DEPENDENCIES) $(EXTRA_cstracer_amd64_linux_DEPENDENCIES) 
...
cstracer_amd64_linux-ct_main.o: ct_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cstracer_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(cstracer_amd64_linux_CFLAGS) $(CFLAGS) -MT cstracer_amd64_linux-ct_main.o -MD -MP -MF $(DEPDIR)/cstracer_amd64_linux-ct_main.Tpo -c -o cstracer_amd64_linux-ct_main.o `test -f 'ct_main.c' || echo '$(srcdir)/'`ct_main.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/cstracer_amd64_linux-ct_main.Tpo $(DEPDIR)/cstracer_amd64_linux-ct_main.Po
#	$(AM_V_CC)source='ct_main.c' object='cstracer_amd64_linux-ct_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cstracer_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(cstracer_amd64_linux_CFLAGS) $(CFLAGS) -c -o cstracer_amd64_linux-ct_main.o `test -f 'ct_main.c' || echo '$(srcdir)/'`ct_main.c

cstracer_amd64_linux-ct_main.obj: ct_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cstracer_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(cstracer_amd64_linux_CFLAGS) $(CFLAGS) -MT cstracer_amd64_linux-ct_main.obj -MD -MP -MF $(DEPDIR)/cstracer_amd64_linux-ct_main.Tpo -c -o cstracer_amd64_linux-ct_main.obj `if test -f 'ct_main.c'; then $(CYGPATH_W) 'ct_main.c'; else $(CYGPATH_W) '$(srcdir)/ct_main.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/cstracer_amd64_linux-ct_main.Tpo $(DEPDIR)/cstracer_amd64_linux-ct_main.Po
#	$(AM_V_CC)source='ct_main.c' object='cstracer_amd64_linux-ct_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
